...
- **[INE Chile — Estimaciones y proyecciones de población 2002–2035 por comuna (base 2017)](https://www.ine.gob.cl/estadisticas-por-tema/demografia-y-poblacion/estimaciones-y-proyecciones-de-poblacion)** — 🌱 `candidate` · `CC-BY-SA-4.0` · _SCL_
  Population for every Chilean comuna, by sex, urban/rural area and age group, for 30 June of each year 2002–2035, projected from the 2017 census.
...
- **[Idescat external trade of Catalonia by province (comest)](https://www.idescat.cat/pub/?id=comest&lang=en)** — ✅ `live` · `Idescat reuse conditions: reuse allowed if the source is cited, the content is not altered and the update date is stated (no named licence)` · reviewed TD 2026-09 · _BCN_
